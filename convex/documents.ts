...
export const get = query({
  ...
  handler: async (ctx, { search, paginationOpts, organizationId: activeOrganizationId }) => {
    const user = await ctx.auth.getUserIdentity();
    ...
    const organizationId = (user.organization_id ?? user.org_id ?? activeOrganizationId ?? undefined) as
      | string
      | undefined;
